...
// src/fs/log.ts
import { mkdir, writeFile as writeFile2 } from "fs";
function writeLog(gen) {
  ...
  mkdir(`${folder}`, { recursive: true }, (error) => {
    writeFile2(`${file}`, JSON.stringify(data, null, 4), (error2) => {
      if (error2) {
...
var Generator = class {
  constructor(servermode, options) {
    ...
    this.fullPath = slash(resolve(root, dir));
    if (servermode === "serve") {
      const watcher = chokidar.watch(this.fullPath, { ignoreInitial: true, depth });
