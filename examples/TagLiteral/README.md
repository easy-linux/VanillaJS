# Пример с примером функции тегового литерала
## Как написать функцию возвращающую объект стилей. 
...
[![Видео здесь](https://img.youtube.com/vi/RjzO3a35_co/0.jpg)](https://www.youtube.com/watch?v=RjzO3a35_co)
